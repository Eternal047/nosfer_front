						...
						<div class="col-12 col-lg-6">
							<div class="Rectangle10" style="margin-left: 50%;" action="registro.php" method="post">
								...
								<div style="margin-left: 50px">
									<div name="nombres" type="text" class="Rectangle21" placeholder="" required> <?php echo $nombres?></div>
								</div>
								<h1 class= "textonormal" style="margin-left: 50px;margin-top: 50px;">Apellidos</h1>
								<div style="margin-left: 50px">
									<div name="apellidos" type="text" class="Rectangle21" placeholder=""><?php echo $Apellidos?></div>
								</div>
								<div>
